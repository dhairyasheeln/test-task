...
console.log(moment([2020]).isLeapYear()); //Lodash
//Array Methods

var lodash = require('lodash');

var character = ['a', 'b', 'c', 'd', false, 0, null];
...
console.log(lodash.drop(character, [n = 4])); //Collection methods
...
console.log(lodash.filter(users, function (o) {
  return !o.active;
}));
console.log(lodash.find(users, function (o) {
  return o.age < 40;
}));
...
//# sourceMappingURL=/test-task.e31bb0bc.js.map